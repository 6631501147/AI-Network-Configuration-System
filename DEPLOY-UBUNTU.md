...
ใช้ไฟล์นี้สำหรับ deploy `AIBasedAutomaticNetworkConfigurationSystem` บน Ubuntu server ที่มี Docker และ Docker Compose plugin อยู่แล้ว
...
```bash
cd /path/to/AIBasedAutomaticNetworkConfigurationSystem
