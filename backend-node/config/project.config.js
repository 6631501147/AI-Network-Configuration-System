...
const projectCode = firstNonEmpty(process.env.PROJECT_CODE, 'aibasedautomaticnetworkconfigurationsystem');
const projectName = firstNonEmpty(process.env.PROJECT_NAME, 'AIBasedAutomaticNetworkConfigurationSystem');
const projectDescription = firstNonEmpty(process.env.PROJECT_DESCRIPTION, 'AI-based automatic network configuration system student project generated from Application Infomation sheet.');
...
const projectBaseUrl = firstNonEmpty(process.env.PROJECT_BASE_URL, 'https://ai-based-automatic-network-configuration-system.mfu.ac.th');
