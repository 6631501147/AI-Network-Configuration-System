...
## AIBasedAutomaticNetworkConfigurationSystem IAM System — Backend Node.js
...
### 1.1 วัตถุประสงค์
ระบบ IAM (Identity and Access Management) ของ AIBasedAutomaticNetworkConfigurationSystem Backend ทำหน้าที่:
...
- รองรับการเชื่อมต่อแบบ B2B สำหรับ AIBasedAutomaticNetworkConfigurationSystem API

### 1.2 ขอบเขต (Scope)
ระบบครอบคลุม:
- AIBasedAutomaticNetworkConfigurationSystem Backend API (`/api/v1/*`)
...
|--------|----------|--------|
| AI Based Automatic Network Configuration System Admin | ผู้ดูแลระบบ AIBasedAutomaticNetworkConfigurationSystem | org-wide access |
| AIBasedAutomaticNetworkConfigurationSystem Manager | ผู้จัดการระดับ Unit | unit-level access |
| AIBasedAutomaticNetworkConfigurationSystem Staff | พนักงานทั่วไป | self-level access |
...
#### FR-02.4 AIBasedAutomaticNetworkConfigurationSystem Scope Isolation
- Groups และ Menus ต้อง filter เฉพาะที่เป็น "AI Based Automatic Network Configuration System Administration" type
- ป้องกันการเข้าถึงข้าม AIBasedAutomaticNetworkConfigurationSystem scope
...
- สร้าง default menus: dashboard, aibasedautomaticnetworkconfigurationsystem registry, security, audit, accounts
