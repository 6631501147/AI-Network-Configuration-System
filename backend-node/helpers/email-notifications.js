...
const APP_ID = 'aibasedautomaticnetworkconfigurationsystem';
...
function baseContext(context) {
    ...
    return Object.assign({
        appName: getEnv('PROJECT_MAIL_APP_NAME', getEnv('APP_NAME', 'AIBasedAutomaticNetworkConfigurationSystem')),
...
function senderFromConfig(config) {
    ...
    return {
        ...
        fromName: cleanString(config && config.fromName) || cleanString(config && config.appName) || 'AIBasedAutomaticNetworkConfigurationSystem',
        appName: cleanString(config && config.appName) || 'AIBasedAutomaticNetworkConfigurationSystem'
    };
}
