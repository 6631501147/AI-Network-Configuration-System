...
const projectName = project.name || process.env.PROJECT_NAME || 'AIBasedAutomaticNetworkConfigurationSystem';
const projectCode = String(project.code || process.env.PROJECT_CODE || 'aibasedautomaticnetworkconfigurationsystem')
  .trim()
  .toLowerCase()
  .replace(/[^a-z0-9]+/g, '-')
  .replace(/^-+|-+$/g, '') || 'aibasedautomaticnetworkconfigurationsystem';
