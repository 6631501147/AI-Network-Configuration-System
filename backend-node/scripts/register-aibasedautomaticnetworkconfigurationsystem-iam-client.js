...
const { createAIBasedAutomaticNetworkConfigurationSystemIamService } = require('../server/integrations/aibasedautomaticnetworkconfigurationsystem/aibasedautomaticnetworkconfigurationsystem-iam.service');
...
function createIamService() {
  return createAIBasedAutomaticNetworkConfigurationSystemIamService({
...
function buildManagedClientConfig() {
  ...
  const projectCode = firstNonEmpty(project.code, 'aibasedautomaticnetworkconfigurationsystem');
  const projectName = firstNonEmpty(project.name, 'AIBasedAutomaticNetworkConfigurationSystem');
  ...
  return {
    ...
    metadata: {
      ...
      environments: [{
        ...
        healthCheckUrl: managedClientConfig.projectBaseUrl.replace(/\/+$/, '') + '/api/v1/aibasedautomaticnetworkconfigurationsystem/documents/stats',
