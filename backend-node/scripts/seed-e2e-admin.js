...
async function run() {
  ...
  const sessionToken = process.env.PROJECT_E2E_ADMIN_X_ACCESS_TOKEN || 'aibasedautomaticnetworkconfigurationsystem-e2e-admin-token';
  ...
  const account = await AccountModel.findOneAndUpdate(
    { email: email },
    {
      $set: {
        ...
        userinfo: {
          firstName: [{ key: 'en', value: 'AIBasedAutomaticNetworkConfigurationSystem' }],
        ...
        control: {
          ...
          device: [{
            ...
            deviceId: 'aibasedautomaticnetworkconfigurationsystem-seed-device',
            fingerprint: 'aibasedautomaticnetworkconfigurationsystem-seed-fingerprint',
            networkKey: '127.0.0',
