...
router.delete("/accounts/:id/aibasedautomaticnetworkconfigurationsystem-access", Account.onCheckAuthorization, canActionAccounts, iamAdminClient.requireScopedAccount, function (request, response) {
