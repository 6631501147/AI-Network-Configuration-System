...
const APP_SCOPE = 'aibasedautomaticnetworkconfigurationsystem';
...
function withAIBasedAutomaticNetworkConfigurationSystemScope(body) {
...
router.post('/type', canEditType, function (request, response) {
  return iamAdminClient.forwardAdminRequest(request, response, {
    method: 'post',
    path: '/security/type',
    data: withAIBasedAutomaticNetworkConfigurationSystemScope(request.body),
    successStatus: 201
  });
});
