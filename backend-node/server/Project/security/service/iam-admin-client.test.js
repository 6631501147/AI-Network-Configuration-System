...
function setScopedGroups() {
  mockServer.state.groups = [
    ...
    },
    {
      ...
      visibleType: { _id: 'type-aibasedautomaticnetworkconfigurationsystem', title: [{ key: 'en', value: 'AI Based Automatic Network Configuration System Administration' }] }
    },
    {
      _id: 'group-3',
      title: [{ key: 'en', value: 'AIBasedAutomaticNetworkConfigurationSystem Operator' }],
      visibleType: { _id: 'type-aibasedautomaticnetworkconfigurationsystem', title: [{ key: 'en', value: 'AI Based Automatic Network Configuration System Administration' }] }
    }
  ];
}
...
function setScopedMenus() {
  mockServer.state.menus = [
    ...
    },
    {
      ...
      type: { _id: 'type-aibasedautomaticnetworkconfigurationsystem', title: [{ key: 'en', value: 'AI Based Automatic Network Configuration System Administration' }] }
    },
    {
...
function setScopedPermissions() {
  mockServer.state.permissions = [
    ...
    {
      _id: 'perm-2',
      name: 'aibasedautomaticnetworkconfigurationsystem.accounts.manage',
    ...
    {
      _id: 'perm-3',
      name: 'aibasedautomaticnetworkconfigurationsystem.lifecycle.manage',
      group: { _id: 'group-2', name: 'AI Based Automatic Network Configuration System Admin' },
...
function resetMockState() {
  ...
  mockServer.state.accounts = [{ _id: 'acc-1', email: 'aibasedautomaticnetworkconfigurationsystem.ops@example.com' }];
...
test.before(async function () {
  ...
  config.iam.requiredAudience = 'aibasedautomaticnetworkconfigurationsystem-api';
  config.iamAdmin.baseUrl = baseUrl;
  config.iamAdmin.tokenPath = '/api/v1/b2b/token';
  config.iamAdmin.basePath = '/api/v1/b2b/admin';
  config.iamAdmin.clientId = 'ai-based-automatic-network-configuration-system-sdk';
  config.iamAdmin.clientSecret = 'super-secret';
  config.iamAdmin.scope = 'iam.security.write iam.audit.read iam.accounts.read';
  config.iamAdmin.audience = 'aibasedautomaticnetworkconfigurationsystem-api';
  originalPermissionTypeTitle = config.security.permissionTypeTitle;
  config.security.permissionTypeTitle = 'AI Based Automatic Network Configuration System Administration';
  ...
  AccountModel.onQuery = async function (query) {
    ...
    if (accountId === 'aibasedautomaticnetworkconfigurationsystem-account-1') {
      return {
...
test('iam-admin-client resolves my permissions from aibasedautomaticnetworkconfigurationsystem account email', async function () {
  ...
  mockServer.state.permissions.push({
    _id: 'perm-config',
    name: 'aibasedautomaticnetworkconfigurationsystem.auth-message.manage',
    group: { _id: 'group-2', name: 'AI Based Automatic Network Configuration System Admin' },
  ...
  mockServer.state.permissions.push({
    _id: 'perm-training',
    name: 'aibasedautomaticnetworkconfigurationsystem.legacy.manage',
    group: { _id: 'group-2', name: 'AI Based Automatic Network Configuration System Admin' },
  ...
  await iamAdminClient.forwardMyPermissions({
    body: { accounts: 'aibasedautomaticnetworkconfigurationsystem-account-1' },
    query: {},
    headers: { lang: 'en' }
  }, response);
  ...
  assert.deepEqual(
    ...
    ['aibasedautomaticnetworkconfigurationsystem.accounts.manage', 'aibasedautomaticnetworkconfigurationsystem.auth-message.manage', 'aibasedautomaticnetworkconfigurationsystem.lifecycle.manage']
  );
  assert.deepEqual(
...
test('iam-admin-client resolves current account and proxies IAM user requests', async function () {
  ...
  assert.equal(response.statusCode, 200);
  assert.equal(response.payload.data.email, 'aibasedautomaticnetworkconfigurationsystem.ops@example.com');
});

test('iam-admin-client allows scoped signin only for accounts inside aibasedautomaticnetworkconfigurationsystem scope', async function () {
  ...
  assert.equal(deniedResponse.payload.error, 'account_not_in_aibasedautomaticnetworkconfigurationsystem_scope');
...
test('iam-admin-client forwards account list and effective permissions', async function () {
  ...
  assert.deepEqual(
    ...
    ['aibasedautomaticnetworkconfigurationsystem.accounts.manage', 'aibasedautomaticnetworkconfigurationsystem.lifecycle.manage']
  );
  assert.deepEqual(
...
test('iam-admin-client lists all aibasedautomaticnetworkconfigurationsystem scoped accounts by default and supports requested pagination', async function () {
  config.security.permissionTypeTitle = 'AI Based Automatic Network Configuration System Administration';
  mockServer.state.accounts = [
...
test('iam-admin-client filters account group options to aibasedautomaticnetworkconfigurationsystem permission type', async function () {
...
test('iam-admin-client syncs only aibasedautomaticnetworkconfigurationsystem scoped account assignments to IAM', async function () {
  mockServer.state.accountAssignments = [
    {
      _id: 'acct-assign-1',
      account: 'acc-1',
  ...
  const result = await iamAdminClient.syncAccountAssignments('aibasedautomaticnetworkconfigurationsystem-account-1', ['group-1', 'group-2']);
...
test('iam-admin-client removes only aibasedautomaticnetworkconfigurationsystem scoped account assignments', async function () {
  mockServer.state.accountAssignments = [
    {
      _id: 'acct-assign-aibasedautomaticnetworkconfigurationsystem',
      account: { _id: 'acc-1', email: 'aibasedautomaticnetworkconfigurationsystem.ops@example.com' },
...
test('iam-admin-client enforces scope guard before account mutations', async function () {
  ...
  assert.equal(denyResponse.payload.error, 'account_not_in_aibasedautomaticnetworkconfigurationsystem_scope');
});
...
test('iam-admin-client invites accounts into aibasedautomaticnetworkconfigurationsystem scope only', async function () {
  mockServer.state.accounts = [{ _id: 'acc-1', email: 'aibasedautomaticnetworkconfigurationsystem.ops@example.com' }];
  mockServer.state.accountAssignments = [];
  ...
  assert.equal(invited.account.email, 'new.aibasedautomaticnetworkconfigurationsystem@example.com');
  assert.deepEqual(
  ...
  await iamAdminClient.forwardInviteAccountToScope({
    headers: { lang: 'en' },
    body: {
      email: 'existing.aibasedautomaticnetworkconfigurationsystem@example.com',
      groupIds: ['group-2']
    }
  }, response);
