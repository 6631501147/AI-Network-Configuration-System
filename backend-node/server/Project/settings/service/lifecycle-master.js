...
const SEED_ACCESS_PROFILES = [
    ...
    { key: 'AIBasedAutomaticNetworkConfigurationSystem_OPERATIONS', defaultScope: 'division', title: { th: 'ปฏิบัติการการเงิน', en: 'AI Based Automatic Network Configuration System Operations' } },
...
const SEED_POSITION_RULES = [
    ...
    { key: 'RULE_AIBasedAutomaticNetworkConfigurationSystem', title: { th: 'สิทธิ์การเงิน', en: 'AI Based Automatic Network Configuration System Rule' }, matchType: 'CONTAINS', matchValues: ['aibasedautomaticnetworkconfigurationsystem', 'การเงิน'], orgScope: 'division', priority: 40, affiliationKeys: ['OPERATIONAL'], profileKeys: ['AIBasedAutomaticNetworkConfigurationSystem_OPERATIONS'] },
