...
function createMockIamServer() {
  const state = {
    ...
    serviceClients: [
      {
        ...
        allowedAudiences: ['aibasedautomaticnetworkconfigurationsystem-api'],
        metadata: {
          targetSystem: 'aibasedautomaticnetworkconfigurationsystem',
      ...
      },
      {
        ...
        clientSecret: 'super-secret',
        clientName: 'AIBasedAutomaticNetworkConfigurationSystem IAM SDK',
        partnerId: 'ai-based-automatic-network-configuration-system-team',
        tenant: 'iam-shared',
        allowedScopes: 'ai.based.automatic.network.configuration.system.registry.read ai.based.automatic.network.configuration.system.registry.write ai.based.automatic.network.configuration.system.report.read iam.security.read iam.security.write iam.audit.read iam.accounts.read',
        allowedAudiences: ['aibasedautomaticnetworkconfigurationsystem-api'],
        metadata: {
          targetSystem: 'aibasedautomaticnetworkconfigurationsystem',
          ownerEmail: 'ai-based-automatic-network-configuration-system.integration@example.com'
        }
      }
    ],
    apps: [
    ...
    types: [
      ...
      {
        _id: 'type-aibasedautomaticnetworkconfigurationsystem',
        title: [{ key: 'en', value: 'AI Based Automatic Network Configuration System Administration' }],
        description: [{ key: 'en', value: 'AIBasedAutomaticNetworkConfigurationSystem controls' }],
        state: true
      }
    ],
    menus: [
      ...
      },
      {
        ...
        description: [{ key: 'en', value: 'AIBasedAutomaticNetworkConfigurationSystem account directory' }],
      ...
      },
      {
        ...
        description: [{ key: 'en', value: 'AIBasedAutomaticNetworkConfigurationSystem account lifecycle' }],
    ...
    accounts: [
      {
        ...
        status: { key: 'ACTIVE' },
        securityGroups: [{ _id: 'group-2', title: [{ key: 'en', value: 'AI Based Automatic Network Configuration System Admin' }] }],
  ...
  function buildToken(client, scope, audience) {
    ...
    ) || 'aibasedautomaticnetworkconfigurationsystem-api';
    const payload = {
      active: true,
      access_token: token,
      token_type: 'Bearer',
      ...
      partner_id: client.partnerId || 'ai-based-automatic-network-configuration-system-team',
  ...
  async function handler(request, response) {
    ...
    if (request.method === 'GET' && pathname === '/api/v1/b2b/clients/me') {
      ...
      writeJson(response, 200, {
        ...
        metadata: {
          targetSystem: payload.client_id === 'sample-sdk' ? 'aibasedautomaticnetworkconfigurationsystem' : 'aibasedautomaticnetworkconfigurationsystem'
        }
      });
      return;
    }
