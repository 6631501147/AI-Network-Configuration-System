# AI Based Automatic Network Configuration System AI Documentation Index

This docs set controls AI-assisted delivery for `ai-based-automatic-network-configuration-system`. Keep it aligned with source code, tests, and release evidence.
...
| `docs/prd/PRD-ai-based-automatic-network-configuration-system.md` | Product requirement truth, or replace with the actual PRD path used by this project. | yes |
