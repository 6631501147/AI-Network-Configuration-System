...
ควบคุม schema, data contract, migration, seed, index และ compatibility ของ AIBasedAutomaticNetworkConfigurationSystem ให้รองรับ feature ใหม่โดยไม่ทำลาย behavior เดิม.
...
- current models:
  ...
  - `backend-node/server/Project/aibasedautomaticnetworkconfigurationsystem/models/*.js`
...
- controllers/services that normalize payload:
  ...
  - `backend-node/server/Project/aibasedautomaticnetworkconfigurationsystem/service/aibasedautomaticnetworkconfigurationsystem_document.js`
...
## Current AIBasedAutomaticNetworkConfigurationSystem Data Areas

| Domain | Main collections/models |
|---|---|
| Accounts | `accounts/models/account.model.js` |
| AIBasedAutomaticNetworkConfigurationSystem documents | `aibasedautomaticnetworkconfigurationsystem/models/aibasedautomaticnetworkconfigurationsystem_document.model.js` |
...
```txt
ทำหน้าที่ Data Model Agent สำหรับ AIBasedAutomaticNetworkConfigurationSystem
FR: [FR-AIBasedAutomaticNetworkConfigurationSystem-xxx]
...
Constraints:
- ยึด model เดิมของ AIBasedAutomaticNetworkConfigurationSystem
