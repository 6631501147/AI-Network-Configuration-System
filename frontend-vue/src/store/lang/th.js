const th = {
    ...
    accounts: {
        directory: {
            title: "สารบบบัญชี",
            subtitle: "ตรวจสอบข้อมูลบัญชีและสิทธิ์ที่มาจาก IAM โดยไม่เก็บ identity master ซ้ำใน AIBasedAutomaticNetworkConfigurationSystem",
            table: {
            ...
            messages: {
                ...
                removeConfirmMessage: "ลบ {account} ออกจาก AIBasedAutomaticNetworkConfigurationSystem หรือไม่?",
                removeSuccess: "ลบบัญชีออกจาก AIBasedAutomaticNetworkConfigurationSystem แล้ว",
                removeError: "ไม่สามารถลบบัญชีออกจาก AIBasedAutomaticNetworkConfigurationSystem ได้",
                ...
                inviteTitle: "เชิญเข้า AIBasedAutomaticNetworkConfigurationSystem",
                inviteSubtitle: "เชิญบัญชีและกำหนดสิทธิ์เข้า AIBasedAutomaticNetworkConfigurationSystem",
                inviteSuccess: "เชิญบัญชีสำเร็จ",
                inviteError: "ไม่สามารถเชิญบัญชีเข้า AIBasedAutomaticNetworkConfigurationSystem ได้"
            },
            invite: {
                email: "อีเมล",
                firstName: "ชื่อ",
                lastName: "นามสกุล",
                groups: "กลุ่ม AIBasedAutomaticNetworkConfigurationSystem",
                groupPlaceholder: "เลือกกลุ่ม AIBasedAutomaticNetworkConfigurationSystem อย่างน้อยหนึ่งกลุ่ม",
                groupRequired: "กรุณาเลือกกลุ่ม AIBasedAutomaticNetworkConfigurationSystem อย่างน้อยหนึ่งกลุ่ม"
            }
        },
        permissions: {
    ...
    setting: {
        ...
        emailNotifications: {
            ...
            subtitle: "จัดการ workflow override ของ AIBasedAutomaticNetworkConfigurationSystem ที่ delegated ไปยัง IAM สำหรับอีเมลด้าน identity เช่น คำเชิญบัญชี รหัส 2FA และการแจ้งเปลี่ยนสถานะบัญชี",
        ...
        workflowActions: {
            ...
            subtitle: "ตั้งค่าพฤติกรรม action ของ AIBasedAutomaticNetworkConfigurationSystem email workflow ที่ delegated ไปยัง IAM เช่น ผู้รับ การเปิดใช้งาน และเงื่อนไขขณะรันระบบ",
        ...
        runtimeAccess: {
            ...
            hints: {
                trustProxy: "ใช้ X-Forwarded-* เมื่อ AIBasedAutomaticNetworkConfigurationSystem อยู่หลัง reverse proxy หรือ ingress",
        ...
        databaseBackup: {
            ...
            subtitle: "จัดการ backup ฐานข้อมูลของ AIBasedAutomaticNetworkConfigurationSystem ผ่าน CMS ทั้งการตั้ง auto backup, สั่ง manual, retention, download และลบไฟล์เก่า",
