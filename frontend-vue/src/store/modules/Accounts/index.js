...
export default {
  ...
  actions: {
    ...
    async removeAIBasedAutomaticNetworkConfigurationSystemAccess({ dispatch, state }, payload) {
      await Service.accounts('remove-aibasedautomaticnetworkconfigurationsystem-access', payload)
      await dispatch('explorer', {
        page: state.pagination.page,
        limit: state.pagination.limit,
        search: state.pagination.search
