const PROJECT_PERMISSION_TYPE_TITLE = process.env.VUE_APP_PROJECT_PERMISSION_TYPE_TITLE || 'AI Based Automatic Network Configuration System Administration'
const PROJECT_PERMISSION_ROOT_PATH = process.env.VUE_APP_PROJECT_PERMISSION_ROOT_PATH || '/ai-based-automatic-network-configuration-system/security/permission'
const PROJECT_APP_ID = process.env.VUE_APP_PROJECT_APP_ID || 'aibasedautomaticnetworkconfigurationsystem'
...
export function normalizeAIBasedAutomaticNetworkConfigurationSystemData (data) {
