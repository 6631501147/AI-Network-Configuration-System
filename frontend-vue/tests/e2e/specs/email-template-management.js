...
module.exports = {
  'Email Template Management action button uses the expected AIBasedAutomaticNetworkConfigurationSystem style': function (browser) {
    browser
    ...
    browser
      ...
      .executeAsync(function (done) {
        ...
        page.deliveryForm.replyTo = 'ops@aibasedautomaticnetworkconfigurationsystem.example.com'
        ...
        browser.assert.equal(result.value.replyTo, 'ops@aibasedautomaticnetworkconfigurationsystem.example.com')
  ...
  'Custom Email Template appears in Workflow Actions': function (browser) {
    ...
    browser
      ...
      .executeAsync(function (done) {
        ...
        modal.local.description = 'AIBasedAutomaticNetworkConfigurationSystem notification when a payment expires.'
        ...
        page.saveTemplate({
          ...
          description: 'AIBasedAutomaticNetworkConfigurationSystem notification when a payment expires.',
